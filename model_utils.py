...
class SparsePruner(object):
    ...
    Self-Damaging Contrastive Learning. ICML, 2021.
    """
...
class DRGRU(nn.RNNBase):
    '''
    Incorporating Dynamic Semantics into Pre-Trained Language Model for Aspect-based Sentiment Analysis. findings of ACL, 2022.
...
class InformationBottleneck(nn.Module):
    ...
    Contrastive Variational Information Bottleneck for Aspect-Based Sentiment Analysis. KBS, 2024.
    '''
